...
#define PINES_PUERTO_1 (0xC) //PINES 1.2 Y 1.3
#define PUERTO_2 (0x40004C00)
...
class UART{
    private:
        ...
        uint32_t puerto, pines_puerto,clk,baudios,uart_1;

    public:
        UART(uint32_t uart_1, uint32_t puerto, uint32_t pines_puerto, uint32_t clk, bool transmision,
                    bool bits, bool paridad, uint32_t baudios, bool comunicacion, bool sobremuestreo,
