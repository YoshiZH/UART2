...
UART::UART(uint32_t _uart_1, uint32_t _puerto, uint32_t _pines_puerto, uint32_t _clk, bool _transmision,bool _bits, bool _paridad, uint32_t _baudios, bool _comunicacion, bool _sobremuestreo,bool _longitud, bool _interrupcion1, bool _interrupcion2)
{
...
void UART:: UART_longitud_caracteres(bool lg){
    BITBAND_PERI(EUSCI_A(EUSCI_A0)-> CTLW0, UC7BIT) = lg;
}
/**************************************************************************
